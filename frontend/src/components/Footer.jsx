    ...
    <footer id="team" className="bg-brand-navy">
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-[13px] text-white/30 mb-6">Built in Brunei.</p>
        ...
        <div className="rounded-2xl border border-white/[0.09] bg-white/[0.04] px-7 py-5
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[14px] font-semibold text-white">AMU Pilot — Active</span>
            </div>
            <div className="text-[12.5px] text-white/35">
              FLOW is accepting ward pilot applications. Each ward gets a dedicated deployment.
            </div>
          </div>
          <a
            href="#contact"
      ...
      <div className="border-t border-white/[0.07]">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row
          justify-between gap-2 text-[11.5px] text-white/25">
