...
const TL_COLORS = { green: '#16a34a', yellow: '#d97706', grey: '#94a3b8' };
    ...
    <div className="flex flex-col gap-2 rounded-xl border border-[#E5E7EB] bg-white p-3 shadow-[0_1px_3px_rgba(15,23,42,0.06)]">
      <div className="flex items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2">
          <span className="traffic-light-dot shrink-0" style={{ backgroundColor: TL_COLORS[tlColor] }} title={tlColor === 'green' ? 'Ready' : tlColor === 'yellow' ? 'Action needed' : 'Not ready'} />
      ...
      <div className="dashboard-page-container dashboard-stack">
        <header className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-[#1F2937]">
            ...
            <strong className="text-[#B45309]">{delayedCount} delayed</strong>{' '}·{' '}{patients.length} total
          </p>
        </header>
